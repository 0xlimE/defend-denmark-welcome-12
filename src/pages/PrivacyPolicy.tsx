          ...
          <div className="container mx-auto px-4 py-12 max-w-4xl">
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="mb-4">
                  <strong>1.1</strong> These terms on the Processing of Personal Data ("Terms") apply to all processing of personal data by Defend Denmark ApS, CVR 45824578, Nørrebrogade 45D 4TH, 2200 KBH N ("Processor" or "Defend Denmark") where Defend Denmark acts as a data processor when providing customer ("Controller") service.
                </p>
