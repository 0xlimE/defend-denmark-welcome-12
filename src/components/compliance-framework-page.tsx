              ...
              <Card className="bg-primary text-primary-foreground shadow-elegant border-0">
                <CardContent className="p-8 md:p-12 text-center">
                  <div className="flex flex-col sm:flex-row gap-4 justify-center items-stretch max-w-2xl mx-auto">
                    ...
                    >
                      <a href="/site-uploads/GlacierFury_290426_2040_SecurityReport.pdf" download>
                        <Download className="mr-2 h-5 w-5" aria-hidden="true" />
                        {t('compliance.cta.download')}
                      </a>
                    </Button>
                    <Button
                      asChild
                      size="lg"
                      variant="outline"
                      className="h-14 text-base px-8 border-2 border-primary-foreground bg-transparent text-primary-foreground hover:bg-primary-foreground hover:text-primary font-semibold"
                    >
                      <a
